...
# I want to see a table with black margin for marital status and the table are allocated in the center of the page 

kable_styling(kable(table(data$Marital.status),
                    caption = "Marital status",
                    col.names = c("Marital status", "Freq"),
                    align = 'c',
                    format = "latex",
                    booktabs = TRUE),
...
data$Nationality <- relevel(data$Nationality, 
                            ref = 'Portoguese')
...
```{r, echo = F}
# Contingency tables for rmarkdown format
# kable(table(train$Marital.status, train$Output),
#       caption = "Marital status",
#       col.names = c("Marital status", "Dropout", "Graduate"),
#       align = 'c',
#       format = "latex",
#       table.attr = 'border = 1')
# 
# kable(table(train$Course, train$Output),
#       caption = "Course",
#       col.names = c("Course", "Dropout", "Graduate"),
#       align = 'c',
#       format = "latex",
#       table.attr = 'border = 1')
```
...
# 
# par(mfrow = c(1, 2))
# kable_styling(kable(table(train$Previous.qualification, train$Output),
#                     caption = "Previous qualification",
#                     col.names = c("Previous qualification", "Dropout", "Graduate"),
#                     align = 'c',
#                     # format = "latex",
#                     booktabs = TRUE),
#               latex_options = c("striped", "hold_position"), 
...
#               font_size = 9
#               )
# kable_styling(kable(table(train$Marital.status, train$Output),
#                     caption = 'Marital status',
#                     col.names = c("Marital status", "Dropout", "Graduate"),
#                     align = 'c',
#                     # format = "latex",
...
#               font_size = 5
#               )
# kable(addmargins(table(train$Marital.status, train$Output), 2),
#                     caption = 'Marital status',
#                     col.names = c("Marital status", "Dropout", "Graduate", 'Freq'),
#                     align = 'c',
#                     # format = "latex",
#                     booktabs = TRUE)
# kable(addmargins(table(train$Marital.status, train$Output), 2),
...
### 4. Model Building
```{r, echo = F, results= 'hide', out.width = '40%', message= FALSE}
library(MASS)
